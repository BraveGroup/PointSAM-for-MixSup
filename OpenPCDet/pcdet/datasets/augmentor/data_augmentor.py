...
class DataAugmentor(object):
    ...
    def random_world_flip(self, data_dict=None, config=None):
        ...
        for cur_axis in config['ALONG_AXIS_LIST']:
            ...
            if 'weak_clusters_label' in data_dict:
                center = data_dict['weak_clusters_label']['center_of_cluster']
                _, center, _ = getattr(augmentor_utils, 'random_flip_along_%s' % cur_axis)(
                    np.zeros([0, 7]), center, return_flip=True, enable=enable
                )
                data_dict['weak_clusters_label']['center_of_cluster'] = center
    ...
    def random_world_rotation(self, data_dict=None, config=None):
        ...
        if 'weak_clusters_label' in data_dict:
            center = data_dict['weak_clusters_label']['center_of_cluster']
            _, center, _ = augmentor_utils.global_rotation(
            np.zeros([0, 7]), center, rot_range=rot_range, return_rot=True, noise_rotation=noise_rot)
            data_dict['weak_clusters_label']['center_of_cluster'] = center
    ...
    def random_world_scaling(self, data_dict=None, config=None):
        ...
        if 'weak_clusters_label' in data_dict:
            center = data_dict['weak_clusters_label']['center_of_cluster']
            _, center, _ = augmentor_utils.global_scaling(
            np.zeros([0, 7]), center, config['WORLD_SCALE_RANGE'], return_scale=True, noise_scale=noise_scale)
            data_dict['weak_clusters_label']['center_of_cluster'] = center
            data_dict['weak_clusters_label']['radius_of_cluster'] *= noise_scale
    ...
    def random_world_translation(self, data_dict=None, config=None):
        ...
        if 'weak_clusters_label' in data_dict:
            data_dict['weak_clusters_label']['center_of_cluster'] += noise_translate
